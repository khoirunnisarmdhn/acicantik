                ...
                <form id="coaEditForm" action="{{ route('coa.update', $coa->id_coa) }}" method="POST" class="p-8">
                    ...
                    <div class="flex justify-end gap-3 mt-10 border-t pt-6 border-gray-100 dark:border-gray-700">
                        <a href="{{ route('coa.index') }}"
                            class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gray-100 text-gray-600 font-bold hover:bg-gray-200 transition duration-200 dark:bg-gray-700 dark:text-gray-300">
